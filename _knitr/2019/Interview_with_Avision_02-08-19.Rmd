...
# prettyjekyll::FormatPost("_knitr/Interview_with_Avision_02-08-19.Rmd")
```
...
```{r purrr, echo=FALSE, out.width = '50%', out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://martinctc.github.io/blog/images/avision-profile.jpeg")
```
...
Avision's also spoken about his journey to become a Data Scientist from an Economics background. Check out this video interview here, on *Data Strategy with Jonathan*:

<iframe width="560" height="315" src="https://www.youtube.com/embed/x5f6Z0TXdlQ" frameborder="0" allowfullscreen></iframe>

If you've got some interesting thoughts or have a project that you'd like to talk about, please [don't hesitate to get in touch](https://twitter.com/martin_rstats)!
