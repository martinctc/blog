...
In this post, I will simulate a _minimal_ labelled survey dataset that can be exported as a SPSS (.SAV) file, with full variable and value labels. I will also attempt to arbitrarily introduce 'meaning' to the dataset so they can be more effectively used as examples.
