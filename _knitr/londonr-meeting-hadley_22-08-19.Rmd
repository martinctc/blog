...
In the first case, I suppose most of us who use **tidyverse** on a regular basis have wondered at at least on one occasion whether we can get rid of the function conflict when we run `library(tidyverse)`. It is the classic programming "problem" of naming variables / functions: you may think a variable name is intuitive or sensible initially, but not thinking it through thoroughly enough can sometimes come back and bite you in the future. 
...
The documentation of `stats::filter()` goes:
