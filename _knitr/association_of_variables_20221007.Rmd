...
One of the most basic tasks in statistics and data science is to understand the relationship between two variables. Sometimes the motivation is understand whether the relationship is causal, but this is not always the case. 
...
When inferring the relationship between two variables - whether a variable `x` has a causal effect on another variable `y` - statisticians and data scientists look at a number of tests and calculations. Here is a non-exhaustive list that you will likely have come across:
