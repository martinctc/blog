...
In my day to day life, I use R for everything starting from data cleaning, visualization, data wrangling, and to create models! I use [ggplot2](https://ggplot2.tidyverse.org/), [caret](http://topepo.github.io/caret/index.html), **timeSeries** (for timeseries) apart from the usual ones.
